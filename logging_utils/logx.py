...
class Logger:
    ...
    def save_state(self, state_dict, itr=None):
        ...
        if proc_id()==0:
            ...
            if hasattr(self, 'pytorch_multiple_saver_elements'):
                self._pytorch_multiple_save(itr)
    ...
    def setup_pytorch_multiple_saver(self, what_to_save, name_to_save):
        """
        Set up easy model saving for a single PyTorch model.
        ...
        Args:
            what_to_save: Any PyTorch model or serializable object containing
                PyTorch models.
        """
        self.pytorch_multiple_saver_elements = what_to_save
        self.name_to_save = name_to_save
        assert len(self.name_to_save)==len(self.pytorch_multiple_saver_elements)
    ...
    def _pytorch_multiple_save(self, itr=None):
        ...
        Saves the PyTorch model (or models).
        """
        for i in range(len(self.pytorch_multiple_saver_elements)):
            if proc_id()==0:
                assert hasattr(self, 'pytorch_multiple_saver_elements'), \
